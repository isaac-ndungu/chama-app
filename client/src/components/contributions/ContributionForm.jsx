    ...
    return (
        <form onSubmit={handleSubmit} style={{ padding: 16, border: '1px solid #ccc', borderRadius: 8, marginBottom: 24 }}>
            ...
            <div>
                ...
                <select id="memberId" name="memberId" value={form.memberId} onChange={handleChange} required>
            ...
            <div>
                ...
                <input id="amount" type="number" name="amount" value={form.amount} onChange={handleChange} required min="1" step="1" placeholder="5000" />
            </div>
            <div>
            ...
            <div>
                ...
                <input id="paymentDate" type="date" name="paymentDate" value={form.paymentDate} onChange={handleChange} required />
            </div>
